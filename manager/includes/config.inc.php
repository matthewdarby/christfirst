 ...
 */
$database_type = 'mysql';
$database_server = 'localhost:/tmp/mysql5.sock';
$database_user = 'cfcSelect';
$database_password = 'mySite';
$database_connection_charset = '';
$dbase = '`christ_homebase`';
$table_prefix = 'christfirst_';
error_reporting(E_ALL & ~E_NOTICE);

$lastInstallTime = 1211057330;

$site_sessionname = 'SN482f44ad98db0';
$https_port = '443';
